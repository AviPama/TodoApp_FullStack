const Todo = require('../backend/models/todomodels.js');

exports.getAllTodos = async(req, res)=>{
    try{
    const tasks = await Todo.find().sort('-createdAt');
    res.json(tasks);
    }catch(err){
...
exports.getTodo = async(req,res)=>{
    ...
    exports.updateTodo = async(req, res)=>{
        try{
            ...
            tasks.description = req.body.description !== undefined
            ? req.body.description
            : tasks.description;

            tasks.completed = req.body.completed !== undefined
            ? req.body.completed
            : tasks.completed;
