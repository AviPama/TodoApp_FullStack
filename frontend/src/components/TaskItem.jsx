                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-start space-x-3 flex-1">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-gray-500 mt-2">Created: {new Date(task.createdAt).toLocaleDateString()}
                        ...
                        <div className="flex items-center space-x-2 ml-4">
                            {/* Edit Button */}
                            <button className="p-2 text-gray-400 hover:text-green-400 hover:bg-green-500/10 rounded-lg transition duration-200" onClick={() => setEditingTask(task._id)}>
                                <Edit2 size={18} />
                            </button>
                            {/* Delete Button */}
                            <button className="p-2 text-gray-400 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition duration-200" onClick={() => deleteTask(task._id)}> 
                                <Trash2 size={18} />
                            </button>    
                        </div>
                    </div>
